...
var translatedText = btnText[languageIndex];
var halfTextWidth = string_width(translatedText) / 2;
draw_text_ext_color(
	x + halfTextWidth/2, y + sprite_height, 
	translatedText, 0, btnWidth, 
	textColor, textColor, textColor, textColor, image_alpha
);
